...
class TTS_API:
    ...
    def __init__(self, node):
        ...
        # Read topic from parameter, with default 'say'
        if self._node.has_parameter('tts_action_topic'):
            self._tts_topic = self._node.get_parameter('tts_action_topic').get_parameter_value().string_value
        else:
            self._tts_topic = 'say'
